...
export const WeatherIcon: FunctionComponent<Props> = ({ iconId, iconCode }) => {
  if (iconId && iconCode) {
    ...
    if (name && Icons[name as keyof IconType]) {
      ...
      return <IconComponent size={24 * 10} strokeWidth={0.1} />
    }
  }
  return <Icons.WiNa size={24 * 10} strokeWidth={0.01} />
}
